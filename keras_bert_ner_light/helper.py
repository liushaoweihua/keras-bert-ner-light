...
if os.name == "nt":
    ...
    root_dir = "/home/projects/Ner/tools/Keras-Bert-Ner-Light/"
...
def train_args_parser():
    ...
    server_group = parser.add_argument_group(
        "Bert_encode_server", "Config the url, port and query timeout for a frozen BERT server")
    server_group.add_argument("-featurizer_url",
                              type=str,
                              default="http://localhost",
                              required=True,
                              help="(REQUIRED) Featurizer server url")
    server_group.add_argument("-featurizer_port",
                              type=str,
                              default="1225",
                              required=True,
                              help="(REQUIRED) Featurizer server port")
    server_group.add_argument("-featurizer_timeout",
                              type=float,
                              default=0.5,
                              help="Featurizer server timeout. Default is 0.5 second")
